...
class ReviewAnalysis(TypedDict): 
  ...
  key_themes: Annotated[str, "Key themes discussed in the review"] # e.g., "Camera, Battery Life, Design"
  summary: Annotated[str, "A brief summary of the review e.g., 'Great product, fast delivery'"] # e.g., "Great product, fast delivery"
  sentiment: Annotated[str, "Return sentiment of the review e.g., 'Positive', 'Negative', 'Neutral'"] # e.g., "Positive", "Negative", "Neutral"
  recommendation: Annotated[str, "Recommendation based on the review"] # e.g., "Yes", "No", "N/A"
  pros: Annotated[str, "List of pros mentioned in the review"] # e.g., "Fast shipping, Good quality"
  cons: Annotated[str, "List of cons mentioned in the review"] # e.g., "Poor packaging, Late delivery"
